<template>
    <div class="top">
        <el-row style="height: 100%">
            <el-col  :xs="24" :sm="24" :md="24" :lg="24" :xl="24" style="height: 100%;position: relative;">
                <div class="grid-left" :style="{ 'width': $store.state.menuWidth, 'display': $store.state.menuWidth === '0px' ? 'none' : ''}">
                    UAM
                </div>
                ...
                <div class="grid-content">
                    <span class="span">和信云应用管理平台 2020.5</span>
                    ...
                    <el-popover
                        ...
                        <p @click="tolink" style="text-align: center">
                            <i class="el-icon-message" style="margin-right: 5px"></i>所有工单</p>
                        <el-button icon="icon icon-icon-chakanxq" slot="reference" @click="xinxiClick"></el-button>
                    </el-popover>
                    </el-badge>
                </div>
            </el-col>
